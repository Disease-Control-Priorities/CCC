...
load("for_parallel_processing/SIDS.Rda")

coverage<-read.csv("new_inputs/Coverage0621_SIDS.csv", stringsAsFactors = F)

# Unit cost adjustment
uc <- readxl::read_excel("new_inputs/DCP3_ NCD Data (SIDS).xlsx", sheet='costs')%>%
