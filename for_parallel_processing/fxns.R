...
project_pop <- function(quality, is, inter, inc.base, inc.val, inc.type, start.year, stop.year, sel.cse, est.pin, covid.in, sc.covid= NULL){
  ...
  setnames(q150d, paste0("V",1:12), paste0(2019:2030))
  setnames(q151d, paste0("V",1:12), paste0(2019:2030))
  ...
  NCDdt <- data.table(`Under 30`= N0pa, `30-69` = N0pb, `70+`=N0pc,  year_id = 2019:2030) %>%
  ...
  NCDdt_int <- data.table(`Under 30`= N1pa, `30-69` = N1pb, `70+`=N1pc,  year_id = 2019:2030) %>%
