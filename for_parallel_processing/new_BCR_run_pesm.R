...
for(is in all.locs[1:77]){
    ...
    projection = project_pop(0.5, is, inter, 0.80, "no", sel.cse, "varying", "yes", "yes", 1)      
    ...
    save(clinical.pin, clinical.dalys, clinical.q30, clinical.dadt, file = paste0("by_country_pesm/full_BCR_", is, ".Rda"))
}
