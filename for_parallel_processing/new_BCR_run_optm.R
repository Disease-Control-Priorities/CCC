...
for(is in all.locs){
    ...
    projection = project_pop(0.9, is, inter, 0.80, "no", sel.cse, "varying", "yes", "yes", 1)      
    ...
    save(clinical.pin, clinical.dalys, clinical.q30, clinical.dadt, file = paste0("by_country_optm/full_BCR_", is, ".Rda"))
}
