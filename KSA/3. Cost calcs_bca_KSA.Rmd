...
noalc.list<-c("Afghanistan", "Bangladesh", "Iran", "Libya", "Sudan", "Yemen", "Saudi Arabia")
...
country_list<-country_list%>%filter(Country%in% locs)
...
# Adjustment database
    ...
    # Add ancillary + above HF costs
     ...
     file.name <- paste0(selected_country,"_adjusted_uc_",UC_Years,".csv")
