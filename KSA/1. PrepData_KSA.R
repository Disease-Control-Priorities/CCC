...
efficacy      <- readxl::read_excel("../new_inputs/DCP3_ NCD Data_KSA.xlsx", sheet='interventions') %>%
...
pin.groups <- readxl::read_excel("../new_inputs/DCP3_ NCD Data_KSA.xlsx", sheet='costs') %>% 
  filter(NCD<=5.7) %>%
...
save.image(file = "PreppedData2023c_2050_KSA.Rda")
