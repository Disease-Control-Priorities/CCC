...
###########################################
load("for_parallel_processing/output2023_pesm.Rda")
...
newdf<-df%>%
  ...
  mutate(DALY.benefit = ifelse(Code%in%c(5.1,5.2,5.3,5.4), DALY.ave*0.06, DALY.ave), #consumer surplus 94%
         DALY.benefit = ifelse(Code %in% c(5.5,5.6), DALY.benefit*0.30, DALY.benefit),  #consumer surplus 70%
...
write.csv(bind_rows(df_code, df_both)%>%arrange(wb2021), "Figures/BCRs_int_pesm.csv")
...
write.csv(df_pkg, "Figures/BCRs_pkg_pesm.csv")
...
ggsave("Figures/bubbleplot_log_pesm.jpeg", height=8, width=10)
...
ggsave("Figures/bubbleplot_pesm.jpeg", height=8, width=10)
...
ggsave("Figures/bubbleplot_log_region_pesm.jpeg", height=8, width=12)
...
#add intervention names
write.csv(bind_rows(df_code, df_both)%>%arrange(wb2021), "Figures/BCRs_int_pesm_5perc.csv")
...
write.csv(df_pkg, "Figures/BCRs_pkg_pesm_5perc.csv")
...
ggsave("Figures/bubbleplot_log_pesm_5perc.jpeg", height=8, width=10)
...
ggsave("Figures/bubbleplot_pesm_5perc.jpeg", height=8, width=10)
...
ggsave("Figures/bubbleplot_log_region_pesm_5perc.jpeg", height=8, width=12)
...
#add intervention names
write.csv(bind_rows(df_code, df_both)%>%arrange(wb2021), "Figures/BCRs_int_pesm_14perc.csv")
...
write.csv(df_pkg, "Figures/BCRs_pkg_pesm_14perc.csv")
...
ggsave("Figures/bubbleplot_log_pesm_14perc.jpeg", height=8, width=10)
...
ggsave("Figures/bubbleplot_pesm_14perc.jpeg", height=8, width=10)
...
ggsave("Figures/bubbleplot_log_region_pesm_14perc.jpeg", height=8, width=12)
