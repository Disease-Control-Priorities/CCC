...
# All data saved
```{r}
file.name <- paste0("output/bca_costs/All_total_cost_2030_intervention_india",".csv")
write.csv(final_all_intervention, file.name)

file.name <- paste0("output/bca_costs/All_total_cost_2030_year_india",".csv")
write.csv(final_all, file.name)

file.name <- paste0("output/bca_costs/All_ICER_india",".csv") #FOR WILL's CODE
write.csv(final_all_ICER, file.name)

file.name <- paste0("output/bca_costs/All_increment_2030_india",".csv")
